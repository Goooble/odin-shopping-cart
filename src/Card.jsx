function Card({ storeCard = true, name, price, desc, img }) {
  ...
  return (
    <div className="rounded-md bg-stone-700 p-3 text-white">
      <img src={img} alt={name+"image"} className="h-50 rounded-xs bg-stone-950" />
      <div className="py-2">
        <p className="mb-1 text-2xl font-medium">{name}</p>
